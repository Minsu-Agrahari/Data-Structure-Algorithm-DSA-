...
public class SolutionPossible {
    ...
    public static boolean possiblePlaces(char[][] board, int row){
    ...
    public static void main(String[] args) {
        ...
        if(possiblePlaces(chessBoard, 0)){
            printBoard(chessBoard);
            System.out.println("Total number of possible places for NQuene is : "); 
        }
        else{
            System.out.println("No possible places for NQuene is : "); 
        }
